...
### **Auto-Install with PowerShell** (Recommended)
...
# 2. Run installer (auto-detect MT5)
...
**Manual Path:** `.\Install-MT5-EA-Auto.ps1 -MT5DataFolder "C:\Path\To\MT5\MQL5"`

**Help:** `.\Install-MT5-EA-Auto.ps1 -Help`

### **Manual Installation**

1. **Download:** https://github.com/beebobby-11/FN/archive/refs/heads/main.zip
2. **Extract** the ZIP file
3. **Find MT5 Data Folder:**
